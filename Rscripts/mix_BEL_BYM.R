...
BEL_BYM_mix_25[[i]]<-clusterApply(cl=cluster, x=1:3, function(z){BEL_leroux_new(y,x,n,p,var,rho=1,niter=1000000,
                                                                              beta_init, psi_init, tau_init,R, wi, sd_psi=0.4, 
                                                                              sd_beta=2, sd_tau=0.6)})
}
save(BEL_BYM_mix_25,file="Results/BEL_BYM_true_mix_25.RData")
