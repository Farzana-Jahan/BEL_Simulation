...
for(i in 1:5){
  ...
  BEL_BYM2_sim_25[[i]]<-clusterApply(cl=cluster, x=1:3, function(z){BEL_leroux_new(y,x,n,p,var,rho=1, niter=1000000,
...
save(BEL_BYM2_sim_25,file="Results/BEL_BYM2_sim_25_sim2.RData")
