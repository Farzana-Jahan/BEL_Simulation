...
for(i in 1:5){
  ...
  BEL_BYM_sim2_100[[i]]<-clusterApply(cl=cluster, x=1:3, function(z){BEL_leroux_new(y,x,n,p,var,rho=0, niter=1000000,
                                                                                     beta_init, psi_init, tau_init,R, wi, sd_psi=1, 
                                                                                     sd_beta=1.7, sd_tau=0.3)})
  
 
}

save(BEL_BYM_sim2_100,file="Results/BEL_BYM_sim2_100.RData")
