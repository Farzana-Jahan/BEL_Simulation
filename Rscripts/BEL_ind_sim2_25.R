...
for(i in 1:5){
  ...
  BEL_ind2_sim_25[[i]]<-clusterApply(cl=cluster, x=1:3, function(z){BEL_leroux_new(y,x,n,p,var,rho=0, niter=1000000,
...
save(BEL_ind2_sim_25,file="Results/BEL_ind2_sim2_25.RData")
