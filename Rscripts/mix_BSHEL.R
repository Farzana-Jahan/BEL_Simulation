...
for(i in 1:5){
  ...
  clusterExport(cl=cluster,varlist = c("y","x","n","p","var","beta_init", "psi_init", "tau_init"
                                       ,"B","B_plus","q","M","MBM", "wi"))
  Porter_BSHEL_mix_25[[i]]<-clusterApply(cl=cluster, x=1:3, fun= function(z){BSHEL(y,x,n,p,q,var,niter=1000000,beta_init, 
...
save(Porter_BSHEL_mix_25,file="Results/BSHEL_porter_mix_25.RData")
